            ...
            <table table border="0" align="center" cellspacing="0" cellpadding="5" width="100%">
              <tbody>
                <tr style="text-align: center;color: while;border:0px solid #efefef;">
                  <td style="width: 100%;text-align: center;font-size: 23px;text-decoration: underline;"><b>LISTE DES RESPONSABLES D'ETABLISSEMENTS</b></td>
                </tr>
              </tbody>
            </table>
            ...
            <table table border="1" align="center" cellspacing="0" cellpadding="5" style="width: 1040px;">
              <tbody>
                <tr style="text-align: center;color: while;border:1px solid #111;background: #f7f7f7;">
                  ...
                  <td style="height: 30px;width: 300px;"><b>&nbsp;NOM</b></td>
                  <td style="height: 30px;width: 150px;"><b>&nbsp;PROVINCE</b></td>
                  <td style="height: 30px;width: 300px;"><b>&nbsp;RESPONSABLE</b></td>
                  <td style="height: 30px;width: 240px;"><b>&nbsp;CONTACT RESPONSABLE</b></td>
                </tr>
                <?php
                    $i=1;
