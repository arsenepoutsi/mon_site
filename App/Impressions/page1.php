            ...
            <table table border="0" align="center" cellspacing="0" cellpadding="5" width="100%">
              <tbody>
                <tr style="text-align: center;color: while;border:0px solid #efefef;">
                  <td style="width: 100%;text-align: center;font-size: 23px;text-decoration: underline;"><b>LISTE DES ETABLISSEMENTS</b></td>
                </tr>
              </tbody>
            </table>
            ...
            <table table border="1" align="center" cellspacing="0" cellpadding="5" style="width: 1040px;">
              <tbody>
                <tr style="text-align: center;color: while;border:1px solid #111;background: #f7f7f7;">
                  ...
                  <td style="height: 30px;width: 390px;"><b>&nbsp;NOM</b></td>
                  <td style="height: 30px;width: 200px;"><b>&nbsp;TYPE</b></td>
                  <td style="height: 30px;width: 200px;"><b>&nbsp;CATEGORIE</b></td>
                  <td style="height: 30px;width: 200px;"><b>&nbsp;PROVINCE</b></td>
                </tr>
                <?php
                    $i=1;
                    $req = $conn ->query("SELECT * FROM etablissement e, province p WHERE e.id_province=p.id_province ORDER BY id_etablissement ASC");
                    if ($req) {
                ...
                <tr style="text-align: center;color: while;border:0px solid #111;">
                  ...
                  <td style="height: 20px;">&nbsp;<?php echo $donnees['type_etablissement']; ?></td>
                  <td style="height: 20px;">&nbsp;<?php echo $donnees['categorie_etablissement']; ?></td>
                  <td style="height: 20px;">&nbsp;<?php echo $donnees['nom_province']; ?></td>
                </tr>
                <?php } } ?>
              </tbody>
            </table>
